pipeline {
  ...
  stages {
    stage('Preparation') {
      steps {
        sh 'git remote add prod https://github.com/studiowebux/webux-logger.git || true'
      }
    }
    ...
    stage('Production') {
      ...
      steps {
        ...
        mail(to: 'tommy@studiowebux.com', subject: 'Webux-logger - Published', body: 'Webux-logger has been published to production')
      }
    }
