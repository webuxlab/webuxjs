pipeline {
  ...
  stages {
    stage('Preparation') {
      steps {
        sh 'git remote add prod https://github.com/studiowebux/webux-mailer.git || true'
      }
    }
    ...
    stage('Production') {
      ...
      steps {
        ...
        mail(to: 'tommy@studiowebux.com', subject: 'Webux-mailer - Published', body: 'Webux-mailer has been published to production')
      }
    }
