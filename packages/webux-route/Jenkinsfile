pipeline {
  ...
  stages {
    stage('Preparation') {
      steps {
        sh 'git remote add prod https://github.com/studiowebux/webux-route.git || true'
      }
    }
    ...
    stage('Production') {
      ...
      steps {
        ...
        mail(to: 'tommy@studiowebux.com', subject: 'Webux-route - Published', body: 'Webux-route has been published to production')
      }
    }
