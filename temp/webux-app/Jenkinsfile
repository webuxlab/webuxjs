pipeline {
  ...
  stages {
    stage('Preparation') {
      steps {
        sh 'git remote add prod https://github.com/studiowebux/webux-app.git || true'
      }
    }
    ...
    stage('Production') {
      ...
      steps {
        ...
        mail(to: 'tommy@studiowebux.com', subject: 'Webux-app - Published', body: 'Webux-app has been published to production')
      }
    }
